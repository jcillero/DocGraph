# Crates Context Report

- Generated at: `2026-05-02 13:10:04`
- Workspace root: `.`
- Root manifest: `Cargo.toml`
- Cargo.lock present: `yes`
- Internal crates detected: `18`
- cargo available: `yes`
- cargo tree status: `OK`
...
members = [
    "crates/action_core",
    "crates/core_domain",
    "crates/workspace_core",
    "crates/io_runtime",
    "crates/spec_runtime",
    "crates/project_runtime",
    "crates/document_text_runtime",
    "crates/llm_core",
    "crates/llm_local",
    "crates/llm_cloud",
    "crates/tool_runtime",
...
slint = { version = "1.8", default-features = true, features = ["std"] }

```

## Internal crates summary

| Crate | Manifest | Dependency count |
| --- | --- | ---: |
| `action_core` | `crates/action_core/Cargo.toml` | 2 |
| `app_services` | `crates/app_services/Cargo.toml` | 2 |
| `cli_app` | `crates/cli_app/Cargo.toml` | 4 |
| `core_domain` | `crates/core_domain/Cargo.toml` | 3 |
| `document_text_runtime` | `crates/document_text_runtime/Cargo.toml` | 5 |
| `io_runtime` | `crates/io_runtime/Cargo.toml` | 4 |
| `llm_cloud` | `crates/llm_cloud/Cargo.toml` | 4 |
| `llm_core` | `crates/llm_core/Cargo.toml` | 1 |
| `llm_local` | `crates/llm_local/Cargo.toml` | 1 |
| `project_runtime` | `crates/project_runtime/Cargo.toml` | 5 |
| `spec_runtime` | `crates/spec_runtime/Cargo.toml` | 2 |
| `tool_runtime` | `crates/tool_runtime/Cargo.toml` | 3 |
| `ui_core` | `crates/ui_core/Cargo.toml` | 2 |
| `ui_i18n` | `crates/ui_i18n/Cargo.toml` | 1 |
| `ui_slint` | `crates/ui_slint/Cargo.toml` | 12 |
| `ui_theme` | `crates/ui_theme/Cargo.toml` | 1 |
| `verify_progress` | `crates/verify_progress/Cargo.toml` | 2 |
| `workspace_core` | `crates/workspace_core/Cargo.toml` | 1 |

## Dependencies by crate

### `action_core`

- Manifest: `crates/action_core/Cargo.toml`
...
- Manifest: `crates/app_services/Cargo.toml`
- Dependencies detected: `2`

- `dependencies`
  - `project_runtime = { path = "../project_runtime" }`
  - `workspace_core = { path = "../workspace_core" }`

### `cli_app`

- Manifest: `crates/cli_app/Cargo.toml`
- Dependencies detected: `4`

- `dependencies`
  - `app_services = { path = "../app_services" }`
  - `core_domain = { path = "../core_domain" }`
  - `tool_runtime = { path = "../tool_runtime" }`
  - `workspace_core = { path = "../workspace_core" }`

### `core_domain`

- Manifest: `crates/core_domain/Cargo.toml`
...
- Manifest: `crates/document_text_runtime/Cargo.toml`
...
- Manifest: `crates/io_runtime/Cargo.toml`
- Dependencies detected: `4`
...
- Manifest: `crates/llm_cloud/Cargo.toml`
- Dependencies detected: `4`

- `dependencies`
  - `llm_core = { path = "../llm_core" }`
...
- Manifest: `crates/llm_core/Cargo.toml`
- Dependencies detected: `1`
...
- Manifest: `crates/llm_local/Cargo.toml`
- Dependencies detected: `1`
...
- Manifest: `crates/project_runtime/Cargo.toml`
- Dependencies detected: `5`
...
- Manifest: `crates/spec_runtime/Cargo.toml`
- Dependencies detected: `2`
...
- Manifest: `crates/tool_runtime/Cargo.toml`
- Dependencies detected: `3`
...
- Manifest: `crates/ui_core/Cargo.toml`
- Dependencies detected: `2`

- `dependencies`
  - `core_domain = { path = "../core_domain" }`
  - `io_runtime = { path = "../io_runtime" }`

### `ui_i18n`

- Manifest: `crates/ui_i18n/Cargo.toml`
- Dependencies detected: `1`
...
- Manifest: `crates/ui_slint/Cargo.toml`
- Dependencies detected: `12`

- `dependencies`
  - `app_services = { path = "../app_services" }`
  - `clipboard-win = "5.4.1"`
  - `document_text_runtime = { path = "../document_text_runtime" }`
  - `io_runtime = { path = "../io_runtime" }`
  - `project_runtime = { path = "../project_runtime" }`
  ...
  - `ui_i18n = { path = "../ui_i18n" }`
  - `ui_theme = { path = "../ui_theme" }`
  - `workspace_core = { path = "../workspace_core" }`

### `ui_theme`

- Manifest: `crates/ui_theme/Cargo.toml`
- Dependencies detected: `1`
...
- Manifest: `crates/verify_progress/Cargo.toml`
- Dependencies detected: `2`
...
- Manifest: `crates/workspace_core/Cargo.toml`
- Dependencies detected: `1`
...
| Dependency | Used by crates |
| --- | --- |
| `clipboard-win` | `ui_slint` |
| `lopdf` | `document_text_runtime` |
| `reqwest` | `llm_cloud` |
| `serde` | `action_core, core_domain, document_text_runtime, io_runtime, llm_cloud, project_runtime, tool_runtime, verify_progress` |
| `serde_json` | `action_core, core_domain, document_text_runtime, io_runtime, llm_cloud, project_runtime, tool_runtime, verify_progress` |
| `sha2` | `core_domain` |
| `zip` | `document_text_runtime` |

## Support signals

- `json`: `detected`
  - evidence: `action_core, core_domain, document_text_runtime, io_runtime, llm_cloud, project_runtime, tool_runtime, verify_progress`
- `jsonl`: `detected`
  - evidence: `io_runtime`
- `pdf`: `detected`
  - evidence: `document_text_runtime`
- `diff`: `detected`
  - evidence: `action_core, tool_runtime`
- `text`: `detected`
  - evidence: `document_text_runtime, workspace_core`
- `llm`: `detected`
  - evidence: `llm_cloud, llm_core, llm_local`
- `tools`: `detected`
  - evidence: `cli_app, tool_runtime, ui_slint`

## Tool design implications

This section is heuristic and non-normative.

- Tool inputs and outputs can plausibly stay structured and traceable through JSON or JSONL-friendly crates already present in the workspace.
- Document-oriented tools can reasonably assume governed PDF inspection or derivation support exists in the current crate graph, without implying mutation or export runtime.
- LLM-facing tool design should stay separated from execution because LLM crates exist, but operational authority still belongs outside the model path.
- The workspace already exposes a distinct tools boundary, so new tool declarations should continue to reference that boundary instead of leaking behavior into project or UI crates.
- Text-first tools remain a good fit because document text derivation support is already visible in the workspace dependency graph.
## cargo tree
...
- cargo_available: `yes`
- cargo_tree_status: `OK`
- cargo_lock_present: `yes`
- internal_crates_detected: `18`
- Report path: `user/output/crates_context_report.md`
